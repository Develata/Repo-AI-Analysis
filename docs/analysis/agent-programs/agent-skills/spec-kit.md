...
sources:
  ...
  - "[GH:superpowers] https://github.com/obra/superpowers — same-category comparison candidate; existing local analysis under agent-programs/agent-skills/superpowers.md"
  - "[GH:scientific-agent-skills] https://github.com/K-Dense-AI/scientific-agent-skills — same-category comparison candidate; existing local analysis under agent-programs/agent-skills/scientific-agent-skills.md"
...
上述项目按 `agent-programs/agent-skills/` 同类范围做定位级对比，未按同一 10 维度框架深审。
