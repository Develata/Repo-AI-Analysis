...
tags: ["agent-infrastructure", "memory", "user-modeling", "stateful-agents", "python", "typescript", "self-hosted"]
previous_repo: ""
successor: ""
...
estimated_storage: "messages/events/peer representations grow with use"
status: active
ratings:
  capability: 4
  usability: 3
...
overall_score: 3.4
sources:
  - "[GH] https://github.com/plastic-labs/honcho"
  - "[GH:api] https://api.github.com/repos/plastic-labs/honcho queried 2026-06-13; stars=5104, forks=611, open_issues_count=158 (GitHub REST counts issues plus PRs), created_at=2023-09-10T21:29:54Z, pushed_at=2026-06-12T23:50:42Z, license=AGPL-3.0, default_branch=main"
  - "[GH:search] GitHub Search API queried 2026-06-13; open issues=69, open PRs=89, merged PRs since 2026-05-14=25 for repo:plastic-labs/honcho"
  - "[GH:languages] https://api.github.com/repos/plastic-labs/honcho/languages queried 2026-06-13; Python=4262520, TypeScript=439641, Dockerfile=1725, Mako=683, Shell=192"
  - "[GH:release] https://api.github.com/repos/plastic-labs/honcho/releases/latest queried 2026-06-13; latest release endpoint unavailable or no GitHub release returned"
  - "[GH:community] https://api.github.com/repos/plastic-labs/honcho/community/profile queried 2026-06-13; health_percentage=62"
  - "[GH:advisories] https://api.github.com/repos/plastic-labs/honcho/security-advisories?per_page=10 queried 2026-06-13; returned 0 advisories; absence of returned advisories is not a security proof"
  - "[GH:local-scan] Local clone /opt/data/tmp/repo_wiki_memory_batch/clones/honcho at commit 340175ad5f8b49b73007481eef1885ffe99ac768 dated 2026-06-11T12:58:11-04:00; git ls-files=869, ext_counts={\".example\": 3, \".json\": 48, \".lock\": 9, \".md\": 41, \".mdx\": 245, \".png\": 33, \".py\": 397, \".svg\": 11, \".toml\": 9, \".ts\": 44, \".yml\": 9, \"[noext]\": 11}, workflows=7, test/spec-ish files=234, manifests=[\"pyproject.toml\", \"Dockerfile\", \"README.md\", \"CONTRIBUTING.md\", \"CHANGELOG.md\", \"LICENSE\"]"
  - "[Hermes:provider] /opt/hermes/plugins/memory/honcho/README.md and plugin.yaml inspected 2026-06-13; Hermes includes a Honcho memory provider with context/dialectic cadence and recall/write controls"
  - "[README] README.md from https://github.com/plastic-labs/honcho local clone inspected 2026-06-13; product claims in this analysis are based on README/docs unless explicitly smoke-tested"
---
...
Honcho 属于 `ai-programs/agent-infrastructure`：它服务于 agent 的长期记忆、上下文组织、知识图谱或状态管理，而不是普通聊天 UI。仓库当前公开、未归档，最近仍有 push；GitHub API 快照显示 stars=5104、forks=611，说明可见度较高，但 REST `open_issues_count=158` 还需和 Search API 拆分的 open issues=69、open PRs=89 一起理解 [GH:api][GH:search]。
...
| 项目 | 定位 | 相对本项目 |
|------|------|-----------|
| Holographic | Hermes 本地 fact store | Holographic 成本和耦合更低；Honcho 的用户建模和 dialectic reasoning 更强 |
| Mem0 | 通用 memory layer | Mem0 更平台/SDK 化；Honcho 更强调 peer/session/user representation |
| Hindsight | graph/entity memory | Hindsight 更偏事实图谱和 observation；Honcho 更偏人的变化模型和对话表征 |
...
| 场景 | CPU | 内存 | 存储 | 说明 |
|------|-----|------|------|------|
| 最小评估 | medium | medium | messages/events/peer representations grow with use | 只读 README/本地 clone 或最小 CLI/API 试用 |
| 推荐部署 | medium | medium | messages/events/peer representations grow with use | 按 README 启动完整 memory/context 工作流，实际依赖模型、数据库和数据量 |
...
| 维度 | 评分 | 说明 |
|------|------|------|
| 社区活跃度 | 3/5 | stars=5104、forks=611、open issues=69、open PRs=89、近 30 天 merged PR=25；star 是可见度信号，不等于质量证明 [GH:api][GH:search] |
| 成熟度 | 3/5 | created_at=2023-09-10T21:29:54Z，latest release=none；memory 生态整体快速迭代，API/数据模型稳定性需按版本观察 [GH:api][GH:release] |
