...
sources:
  ...
  - "[GH:readme] Local README.md checked 2026-05-20; describes Dify as open-source LLM app development platform combining agent workflow, RAG pipeline, agent capabilities, model management and observability; minimum CPU >=2 cores and RAM >=4 GiB; license is Dify Open Source License based on Apache 2.0 with additional conditions"
